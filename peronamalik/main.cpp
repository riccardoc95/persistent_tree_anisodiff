//g++ main.cpp -o pm -I/opt/homebrew/include -L/opt/homebrew/lib -lcfitsio -lm -std=c++17 ###command line to compile
...
int main(int argc, char *argv[]){
    ...
    filename = "outputs/"+p.filename().string();
